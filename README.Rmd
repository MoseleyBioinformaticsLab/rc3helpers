...
A nice thing about this function, is it creates the `study_id` to `sample_id` mapping file `sample_metadata.tsv`, with the assumption that all of the samples in the directory are associated with the same `study_id` provided by the `studyid` argument.
